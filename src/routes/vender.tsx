      ...
      <section className="bg-gradient-primary">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 py-20 md:grid-cols-2 md:py-28">
          <div className="text-black">
            ...
            <h1 className="mt-4 font-display text-4xl font-bold md:text-6xl">Venda de forma simples, segura e profissional.</h1>
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              { icon: BarChart3, title: "Relatórios de vendas", desc: "Vendas por lote, setor e cupom." },
              { icon: Ticket, title: "Gestão de lotes e setores", desc: "Organize sua bilheteria por lote e setor." },
            ].map((f) => (
