...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PAGOU — Comprou. Pagou. Aproveitou." },
      { name: "description", content: "Plataforma brasileira de venda de ingressos para shows, cursos e produtos digitais. Compra rápida, pagamento seguro, ingresso na hora." },
